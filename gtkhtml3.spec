...
* Thu Jun 17 2010 Matthew Barnes <mbarnes@redhat.com> - 3.28.3-2.el6
- Add patch for RH bug #588457 (issues with Format->Wrap Lines).

* Tue Mar 02 2010 Matthew Barnes <mbarnes@redhat.com> - 3.28.3-1.el6
- Update to 3.28.3

* Tue Jan 12 2010 Milan Crha <mcrha@redhat.com> - 3.28.2-3.el6
- Remove unneeded requirements and add one explicit

* Tue Jan 12 2010 Milan Crha <mcrha@redhat.com> - 3.28.2-2.el6
- Correct Source URL

* Mon Jan 04 2010 Milan Crha <mcrha@redhat.com> - 3.28.2-1.el6
- Update to 3.28.2
